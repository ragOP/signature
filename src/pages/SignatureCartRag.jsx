...
function SignatureCartRag() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const abodentCartEmail = abodentCartRes.data.data.email;
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            await axios.delete(
              `${BACKEND_URL}/api/signature/rag/delete-order-abd/${abodentCartEmail}`
            );

            navigate("/signature-order-confirmation/rag", {
              state: {
                orderId: data.orderId,
                amount: total,
              },
...
export default SignatureCartRag;
