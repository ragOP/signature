...
import { CheckCircle, Star, Sparkles, ArrowLeft, FileText, AlertCircle, Loader2, RefreshCw } from 'lucide-react';
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-800 font-semibold">₹{amount || 'N/A'}</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-gray-600 text-sm font-primary">Payment Method</p>
                    <p className="text-gray-800 font-primary">{paymentMethod || 'Cashfree'}</p>
                  </div>
                  <div className="space-y-2">
