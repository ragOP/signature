...
import landerSignature from '../signature/assets/lander-signature.json';

const BrandSignatureOverlayRag = ({ onAnimationComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Light White Writing Gradient */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white/5 via-transparent to-white/3"></div>
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-white/3 via-transparent to-white/5"></div>
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-white/2 via-transparent to-white/4"></div>
        </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="mb-8 text-center">
          <h1 className="font-signature text-6xl sm:text-5xl lg:text-6xl text-white font-semibold leading-none">
...
export default BrandSignatureOverlayRag;
