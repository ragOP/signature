            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 opacity-5 pointer-events-none">
                  <div
                    className="absolute top-2 right-2 w-16 h-16 bg-gradient-to-br from-gray-400 to-gray-600"
                    style={{
                      clipPath:
                  ...
                  ></div>
                  <div
                    className="absolute bottom-2 left-2 w-12 h-12 bg-gradient-to-br from-gray-400 to-gray-600"
                    style={{
                      clipPath:
                        "polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)",
                    }}
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center space-x-4 mb-4">
                    <div
                      className={`w-12 h-12 bg-gradient-to-br ${audience.color} rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110`}
                    >
