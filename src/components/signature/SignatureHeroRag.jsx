...
const SignatureCard = ({ animateElements }) => {
  const features = [
    {
      icon: Check,
      text: "3 unique designer signature options",
      color: "text-green-600",
    },
    {
      icon: Download,
      text: "Signature writing tutorial",
      color: "text-blue-600",
    },
    {
      icon: Download,
      text: "Practice sheet (PDF format)",
      color: "text-purple-600",
    },
    {
      icon: Clock,
      text: "Delivered within 24–48 hours via email",
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-lg border border-gray-100 p-4 transition-all duration-1000 transform ${
        animateElements
    ...
    >
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-xs text-gray-600">
          A handcrafted, custom-designed signature that reflects your style,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4 mt-4">
        {features.map((feature, index) => {
          ...
          return (
            <div
              key={index}
              className={`flex items-center space-x-2 p-2 rounded-md bg-gray-50 hover:bg-gray-100 transition-all duration-300 delay-${
                index * 100
              } transform ${
                animateElements
      ...
      <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-lg p-3 border border-blue-100">
        <div className="flex flex-col items-center justify-center text-center space-y-2">
          ...
          <div className="text-xs text-gray-600">— secure yours today!</div>
        </div>
      </div>
    </div>
  );
          ...
          >
            ...
            <div className="space-y-3 text-center">
              ...
              <p className="text-md sm:text-xl text-gray-700 leading-relaxed font-display">
                Make your name unforgettable with a designer signature crafted
                just for you.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-100">
              <div className="flex items-center space-x-3">
                ...
                <div className="text-xs text-gray-700">
                  <span className="font-semibold">2,500+ professionals</span>{" "}
                  trust our signatures
                </div>
              </div>
            </div>
          </div>
