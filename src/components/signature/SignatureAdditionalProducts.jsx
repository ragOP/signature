          ...
          <div className="space-y-4">
            {products.map((product) => (
              <div key={product.id} className="space-y-3">
                <div className="flex items-start space-x-4 rounded-xl hover:bg-gray-50 transition-all duration-300">
                  <div className="relative mt-2">
                    ...
                    <label
                      ...
                      className={`relative flex items-center justify-center w-6 h-6 rounded-lg border-2 cursor-pointer transition-all duration-300 transform hover:scale-110 ${selectedProducts.includes(product.id)
                          ? 'bg-gradient-to-r from-gray-800 to-black border-gray-700 shadow-lg'
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <label htmlFor={`product-${product.id}`} className="text-gray-800 font-semibold text-lg cursor-pointer hover:text-gray-900 transition-colors">
                          {product.title}
                        </label>
